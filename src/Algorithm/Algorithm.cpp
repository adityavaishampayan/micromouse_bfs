...
/**
 * @brief A function to drive the robot through the maze until the goal is reached.
 * @param robot
 */
void fp::Algorithm::drive(std::shared_ptr<fp::LandBasedRobot> robot)
{
...
/**
 * @brief A function to plan a path for the robot to reach the goal using the BFS.
 * @param robot
 * @return 
 */
std::vector<fp::Cell> fp::Algorithm::planPath(std::shared_ptr<fp::LandBasedRobot> robot)
{
...
/**
 * @brief A function to provide the action sequence based on the solution path provided by the BFS algorithm.
 * @param robot
 * @param path
 * @return 
 */
std::vector<char> fp::Algorithm::planActions(std::shared_ptr<LandBasedRobot> robot, const std::vector<fp::Cell>& path) 
{
...
/**
 * @brief A funtion to check whether the cell is an element of path
 * @param c
 * @param path
 * @return Boolean value
 */
bool fp::Algorithm::isElementOf(const fp::Cell& c, const std::vector<fp::Cell>& path)
{
	for (auto cell : path)
		if (c == cell)
			return true;
...
/**
 * @brief A function to draw the path planned by the BFS.
 * @param robot 
 * @param path
 * @param currentIndex
 */
void fp::Algorithm::highlightPath(std::shared_ptr<fp::LandBasedRobot> robot, const std::vector<fp::Cell>& path, int currentIndex)
{
