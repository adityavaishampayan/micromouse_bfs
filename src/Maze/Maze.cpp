...
/**
 * @brief A constructor of the Maze class which initializes the dimensions of the maze and stores the maze.
 */
fp::Maze::Maze()
...
/**
 * @brief A function to insert a wall in the maze as the robot encounters it.
 * @param c1
 * @param c2
 */
...
/**
 * @brief A function to check if a wall is present.
 * @param c1
 * @param c2
...
/**
 * @brief A function to check if the adjacent cell that we are looking at is inside the bounds of the maze.
 * @param c
 * @return Boolean value
 */
...
/**
 * @brief A function which returns the value present in the adjacency matrix corresponding to the provided cells.
 * @param c1_index
 * @param c2_index
 * @return 
 */
...
/**
 * @brief A function to display the maze.
 */
